...
namespace Cartive\Favorite_Artists\Core;
...
abstract class Config {
	...
	public static function init( $main_file ) {
		...
		$data                    = \get_file_data( $main_file, array( 'Plugin Name', 'Version' ) );
		self::$values['NAME']    = __( $data[0], 'favorite-artists' );
	...
	public static function sanitize_slug( $string, $sep = '-' ) {
		...
		$slug = \str_replace( array( ' ', '_', '-' ), $sep, $slug );
